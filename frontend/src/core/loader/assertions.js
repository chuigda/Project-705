...
import { enableChainAPI } from '@app/util/type_assert'
...
export const ruleSetDescriptorAssertion = {
   ident: {
      author: 'string',
      moduleName: 'string'
   },
...
export const ruleSetContentAssertion = {
   name: translationKeyAssertion,
...
export const ruleSetAssertion = {
   highOrder: 'boolean'.assertValue(false).orNull(),
   descriptor: ruleSetDescriptorAssertion,
   content: ruleSetContentAssertion
}

export const highOrderRuleSetAssertion = {
   highOrder: 'boolean'.assertValue(true),
   descriptor: ruleSetDescriptorAssertion,
   generator: 'function'
}

export const moduleAssertion = ruleSetAssertion.sumWith(highOrderRuleSetAssertion)
