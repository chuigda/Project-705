...
class 计算上下文:
    ...
    def 计算这回合可以学什么(self) -> list[可用技能]:
        ...
        if self.基础技能等级['体魄'] == 4 and self.基础技能等级['精神'] == 5:
            for 赛道 in 主科技能赛道:
                赛道等级 = max(self.主科技能等级[赛道] + 1, 赛道初始技能等级(主科技能赛道[赛道]))
            ...
            for 赛道 in 课余技能赛道:
                赛道等级 = max(self.课余技能等级[赛道] + 1, 赛道初始技能等级(课余技能赛道[赛道]))
            ...
            for 赛道 in 基础技能赛道:
                赛道等级 = max(self.基础技能等级[赛道] + 1, 赛道初始技能等级(基础技能赛道[赛道]))
    ...
    def 下一回合(self) -> bool:
        ...
        技能等级 = self.最高技能等级()
        属性产出 = 技能活动产出属性公式(技能等级) * 9
        技能点产出 = 技能活动产出技能点公式(技能等级) * 9
        self.属性 += 属性产出
        self.技能点 += 技能点产出
        self.属性曲线.append(self.属性)
        self.技能点曲线.append(self.技能点)
